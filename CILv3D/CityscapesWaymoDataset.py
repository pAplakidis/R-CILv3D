...
class CityscapesWaymoDataset(torch.utils.data.Dataset):
    ...
    def transforms(self, image: np.ndarray, label: np.ndarray) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        # Flip image & label horizontally during training
